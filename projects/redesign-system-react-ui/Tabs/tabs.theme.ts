...
function tabsAlignDirection(align: TabStackedTypes): string {
  switch (align) {
...
export function tabsTheme(props: TabsInterface): Record<string, any> {
  const {
    align,
    theme: { Tabs },
  } = props
...
export function tabsButtonTheme(
  props: TabButtonInterface
): Record<string, any> {
  const {
    item,
...
export function tabsListTheme(props: TabsListInterface): Record<string, any> {
  const {
    theme: { TabsList },
  } = props
...
export function tabsPanelTheme(props: TabPanelInterface): Record<string, any> {
  const {
    theme: { color, Tabs },
  } = props
