...
import { ACTIVE, DISABLED } from '@redesign-system/theme/libs'
...
export function createPageNumbers({
  ...
  readonly onPageClick: (e: React.SyntheticEvent<EventTarget>) => void
...
export const Pagination: FC<PaginationInterface> = function Pagination({
  ...
  return (
    ...
    >
      ...
      {createPageNumbers({ currentPage, onPageClick, total })}
      <Button
        onClick={onNext}
