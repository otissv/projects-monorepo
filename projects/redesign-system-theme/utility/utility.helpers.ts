...
import { maybeString } from 'c-ufunc/maybeString'
import { toCamel } from 'c-ufunc/toCamel'
import { toUpperFirst } from 'c-ufunc/toUpperFirst'
...
export function getBackgroundClip(
...
export function getJustifyItems(
  value: FlexContentTypes
): {
...
export function getJustifySelf(
  value: FlexSelfTypes
): {
...
export function getAlignContent(
  value: FlexContentTypes
): {
...
export function getOverflowWrap(
...
export function getFilterBlur(
  filterBlur: string
): { readonly filterBlur: string } {
  return { filterBlur }
}

export function getFilterBrightness(
...
export function getFilterContrast(
...
export function getFilterDropShadow(
...
export function getFilterGrayscale(
...
export function getFilterHueRotate(
...
export function getFilterSaturate(
...
export function getFilterSepia(
  filterSepia: string
 ...
 * Table
 */
export function getBorderCollapse(
