...
export interface UtilityInterface {
   ...
   * Display
   */
  readonly display: (display: DisplayTypes) => {
  ...
  readonly backgroundClip: (backgroundClip: BackgroundClipTypes) => {
    readonly backgroundClip: BackgroundClipTypes
  }
  readonly bgl: (backgroundClip: BackgroundClipTypes) => {
    readonly backgroundClip: BackgroundClipTypes
  }
  ...
  readonly backgroundRepeat: (backgroundRepeat: BackgroundRepeatTypes) => {
    readonly backgroundRepeat: BackgroundRepeatTypes
  }
  readonly bgr: (backgroundRepeat: BackgroundRepeatTypes) => {
    readonly backgroundRepeat: BackgroundRepeatTypes
  }
  readonly backgroundSize: (backgroundSize: BackgroundSizeTypes) => {
    readonly backgroundSize: BackgroundSizeTypes
  }
  readonly bgs: (backgroundSize: BackgroundSizeTypes) => {
    readonly backgroundSize: BackgroundSizeTypes
  }
  readonly backgroundImage: (backgroundImage: string) => {
    readonly backgroundImage: string
  }
  readonly bgi: (backgroundImage: string) => {
    readonly backgroundImage: string
  }
  ...
  readonly borderY: (border: BorderInterface) => (value: string) => {
    readonly borderTop: string
    readonly borderBottom: string
  }
  readonly borderWidth: (borderWidth: string) => {
  ...
  readonly bdy: (border: BorderInterface) => (value: string) => {
    readonly borderTop: string
    readonly borderBottom: string
  }
  ...
  readonly borderYRadius: (radius: RadiusInterface) => (radius: string) => {
  ...
  readonly ry: (radius: RadiusInterface) => (value: string) => {
    readonly borderTopRadius: string
    readonly borderBottomRadius: string
  }
   ...
   * Margin
   */
  readonly margin: (value: string | number) => {
    readonly margin: string | number
  }
  readonly marginTop: (value: string | number) => {
    readonly marginTop: string | number
  }
  readonly marginRight: (value: string | number) => {
    readonly marginRight: string | number
  }
  readonly marginBottom: (value: string | number) => {
    readonly marginBottom: string | number
  }
  readonly marginLeft: (value: string | number) => {
    readonly marginLeft: string | number
  }
  readonly marginX: (value: string | number) => {
    readonly marginRight: string | number
    readonly marginLeft: string | number
  }
  readonly marginY: (value: string | number) => {
  ...
  readonly mt: (value: string | number) => {
    readonly marginTop: string | number
  }
  readonly mr: (value: string | number) => {
    readonly marginRight: string | number
  }
  readonly mb: (value: string | number) => {
    readonly marginBottom: string | number
  }
  readonly ml: (value: string | number) => {
    readonly marginLeft: string | number
  }
  readonly mx: (value: string | number) => {
    readonly marginRight: string | number
    readonly marginLeft: string | number
  }
  readonly my: (value: string | number) => {
    readonly marginTop: string | number
    readonly marginBottom: string | number
  }
   ...
   * Padding
   */
  readonly padding: (value: string | number) => {
    readonly padding: string | number
  }
  readonly paddingTop: (value: string | number) => {
    readonly paddingTop: string | number
  }
  readonly paddingRight: (value: string | number) => {
    readonly paddingRight: string | number
  }
  readonly paddingBottom: (value: string | number) => {
    readonly paddingBottom: string | number
  }
  readonly paddingLeft: (value: string | number) => {
    readonly paddingLeft: string | number
  }
  readonly paddingX: (value: string | number) => {
    readonly paddingRight: string
    readonly paddingLeft: string | number
  }
  readonly paddingY: (value: string | number) => {
  ...
  readonly pTop: (value: string | number) => {
    readonly paddingTop: string | number
  }
  readonly pRight: (value: string | number) => {
    readonly paddingRight: string | number
  }
  readonly pBottom: (value: string | number) => {
    readonly paddingBottom: string | number
  }
  readonly pLeft: (value: string | number) => {
    readonly paddingLeft: string | number
  }
  ...
  readonly bs: (boxSizing: BoxSizingTypes) => {
    readonly boxSizing: BoxSizingTypes
  }
  ...
  readonly flexGrow: (flexGrow: number | string) => {
    readonly flexGrow: number | string
  }
  readonly flg: (flexGrow: string) => { readonly flexGrow: string }
  readonly flexShrink: (flexShrink: string | number) => {
    readonly flexShrink: string | number
  }
  readonly fls: (flexShrink: string | number) => {
    readonly flexShrink: string | number
  }
  readonly flexDirection: (flexDirection: FlexDirectionTypes) => {
    readonly flexDirection: FlexDirectionTypes
  }
  readonly fld: (flexDirection: FlexDirectionTypes) => {
    readonly flexDirection: FlexDirectionTypes
  }
  readonly flexWrap: (flexWrap: FlexWrapTypes) => {
    readonly flexWrap: FlexWrapTypes
  }
  readonly flw: (flexWrap: FlexWrapTypes) => {
    readonly flexWrap: FlexWrapTypes
  }
  readonly flexBasis: (flexBasis: string | number) => {
    readonly flexBasis: string | number
  }
  readonly flb: (flexBasis: string | number) => {
    readonly flexBasis: string | number
  }
  ...
  readonly od: (flexShrink: number | string) => {
    readonly order: number | string
  }

  readonly justifyContent: (justifyContent: FlexContentTypes) => {
    readonly justifyContent: FlexContentTypes
  }
  readonly jc: (justifyContent: FlexContentTypes) => {
    readonly justifyContent: FlexContentTypes
  }
  readonly justifyItems: (justifyItems: FlexItemsTypes) => {
    readonly justifyItems: FlexItemsTypes
  }
  readonly ji: (justifyItems: FlexItemsTypes) => {
    readonly justifyItems: FlexItemsTypes
  }
  readonly justifySelf: (justifySelf: FlexSelfTypes) => {
    readonly justifySelf: FlexSelfTypes
  }
  readonly js: (justifySelf: FlexSelfTypes) => {
    readonly justifySelf: FlexSelfTypes
  }

  readonly alignContent: (alignContent: FlexContentTypes) => {
    readonly alignContent: FlexContentTypes
  }
  readonly ac: (alignContent: FlexContentTypes) => {
    readonly alignContent: FlexContentTypes
  }
  readonly alignItems: (alignItems: FlexItemsTypes) => {
    readonly alignItems: FlexItemsTypes
  }
  readonly ai: (alignItems: FlexItemsTypes) => {
    readonly alignItems: FlexItemsTypes
  }
  readonly alignSelf: (alignSelf: FlexSelfTypes) => {
    readonly alignSelf: FlexSelfTypes
  }
  readonly af: (alignSelf: FlexSelfTypes) => {
    readonly alignSelf: FlexSelfTypes
  }
  ...
  readonly wordBreak: (wordBreak: WordBreakTypes) => {
    readonly wordBreak: WordBreakTypes
  }
  readonly wb: (wordBreak: WordBreakTypes) => {
    readonly wordBreak: WordBreakTypes
  }

  readonly listStyle: (listStyle: ListStyleTypes) => {
    readonly listStyle: ListStyleTypes
  }
  readonly lt: (listStyle: ListStyleTypes) => {
    readonly listStyle: ListStyleTypes
  }
  readonly listPosition: (listPosition: ListPositionTypes) => {
    readonly listPosition: ListPositionTypes
  }
  readonly lp: (listPosition: ListPositionTypes) => {
    readonly listPosition: ListPositionTypes
  }
  readonly textDecoration: (textDecoration: TextDecorationTypes) => {
    readonly textDecoration: TextDecorationTypes
  }
  readonly td: (textDecoration: TextDecorationTypes) => {
    readonly textDecoration: TextDecorationTypes
  }
  readonly textTransform: (textTransform: TextTransformTypes) => {
    readonly textTransform: TextTransformTypes
  }
  readonly tt: (textTransform: TextTransformTypes) => {
    readonly textTransform: TextTransformTypes
  }
  readonly verticalAlign: (verticalAlign: VerticalAlignTypes) => {
    readonly verticalAlign: VerticalAlignTypes
  }
  readonly va: (verticalAlign: VerticalAlignTypes) => {
    readonly verticalAlign: VerticalAlignTypes
  }
  readonly whiteSpace: (whiteSpace: WhiteSpaceTypes) => {
    readonly whiteSpace: WhiteSpaceTypes
  }
  readonly ws: (whiteSpace: WhiteSpaceTypes) => {
    readonly whiteSpace: WhiteSpaceTypes
  }
   ...
   * Position
   */
  readonly position: (position: PositionTypes) => {
   ...
   * Overflow
   */
  readonly overflow: (overflow: OverflowTypes) => {
    readonly overflow: OverflowTypes
  }
  readonly of: (overflow: OverflowTypes) => { readonly overflow: OverflowTypes }
  readonly overflowX: (overflowX: OverflowTypes) => {
    readonly overflowX: OverflowTypes
  }
  readonly ox: (overflowX: OverflowTypes) => {
    readonly overflow: OverflowTypes
  }
  readonly overflowY: (overflowY: OverflowTypes) => {
    readonly overflowY: OverflowTypes
  }
  readonly oy: (overflowY: OverflowTypes) => {
    readonly overflow: OverflowTypes
  }
  readonly overflowScrolling: (overflowScrolling: OverflowScrollingTypes) => {
    readonly '-webkit-Overflow-scrolling': OverflowScrollingTypes
  }
  readonly os: (overflowScrolling: OverflowScrollingTypes) => {
    readonly '-webkit-Overflow-scrolling': OverflowScrollingTypes
  }
  readonly overflowWrap: (overflowWrap: OverflowWrapTypes) => {
    readonly overflowWrap: OverflowWrapTypes
  }
  readonly ow: (overflowWrap: OverflowWrapTypes) => {
    readonly overflowWrap: OverflowWrapTypes
  }
   ...
   * Z Index
   */
  readonly zIndex: (zIndex: number | string | 'auto') => {
    readonly zIndex: number | string | 'auto'
  }
  readonly z: (zIndex: number | string | 'auto') => {
    readonly zIndex: number | string | 'auto'
  }
   ...
   * Object
   */
  readonly objectFit: (objectFit: ObjectFitTypes) => {
    readonly objectFit: ObjectFitTypes
  }
  readonly ot: (objectFit: ObjectFitTypes) => {
    readonly objectFit: ObjectFitTypes
  }
  readonly objectPosition: (objectPosition: ObjectPositionTypes) => {
    readonly objectPosition: ObjectPositionTypes
  }
  readonly op: (objectPosition: ObjectPositionTypes) => {
    readonly objectPosition: ObjectPositionTypes
  }
   ...
   * Visibility
   */
  readonly visibility: (visibility: VisibilityTypes) => {
    readonly visibility: VisibilityTypes
  }
  readonly vs: (visibility: VisibilityTypes) => {
    readonly visibility: VisibilityTypes
  }
  ...
  readonly appearance: (appearance: AppearanceCssTypes) => {
    readonly appearance: AppearanceCssTypes
  }
  readonly ap: (appearance: AppearanceCssTypes) => {
    readonly appearance: AppearanceCssTypes
  }
  readonly pointerEvents: (pointerEvents: PointerEventsTypes) => {
    readonly pointerEvents: PointerEventsTypes
  }
  readonly pe: (pointerEvents: PointerEventsTypes) => {
    readonly pointerEvents: PointerEventsTypes
  }
  readonly resize: (resize: ResizeTypes) => { readonly resize: ResizeTypes }
  readonly rs: (resize: ResizeTypes) => { readonly resize: ResizeTypes }
  readonly userSelect: (userSelect: UserSelectTypes) => {
    readonly userSelect: UserSelectTypes
  }
  readonly us: (userSelect: UserSelectTypes) => {
    readonly userSelect: UserSelectTypes
  }
   ...
   * Transition
   */
  readonly transition: (transition: TransitionTypes) => {
