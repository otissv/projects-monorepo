...
var chain = function () {
    ...
    return ({
        chain: function (fn) {
            ...
            return exports.chain.apply(void 0, tslib_1.__spreadArray(tslib_1.__spreadArray([], fns, true), [fn], false));
        },
        exec: function (initialValue) {
            return fns.reduce(function (previousValue, fn) { return fn(previousValue); }, initialValue);
        },
    });
};
exports.chain = chain;
