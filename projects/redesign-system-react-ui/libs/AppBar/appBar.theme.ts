...
export function appBarTheme(props: AppBarInterface): Record<string, any> {
  const {
...
export function appBarNavTheme(props: AppBarNavInterface): Record<string, any> {
  const {
    theme: { AppBarNav },
  } = props
...
export function appBarContentTheme(
  props: AppBarInterface
): Record<string, any> {
  const {
...
export function appBarBrandTheme(props: AppBarInterface): Record<string, any> {
  const {
    theme: { AppBarBrand },
  } = props
...
export function appBarPanelTheme(props: AppBarInterface): Record<string, any> {
  const {
    opened,
...
export function appBarSearchTheme(props: AppBarInterface): Record<string, any> {
  const {
...
export function appBarTriggerTheme(
  props: AppBarInterface
): Record<string, any> {
  const {
...
export function appBarFooterTheme(props: AppBarInterface): Record<string, any> {
  const {
