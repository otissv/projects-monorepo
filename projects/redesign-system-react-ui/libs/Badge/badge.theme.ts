...
export function badgeTheme(props: BadgeInterface): Record<string, any> {
  const {
...
export function badgePillTheme(props: BadgeInterface): Record<string, any> {
  const {
    pill,
    theme: { Badge },
  } = props
