...
export const isUrl = <Value>(value: Value, includeLocal = false): boolean => {
  ...
  const localhostDomainRE =
    / (0{0,4}:{1,2}){1,7}(0{0,3}1)|^localhost(:[0-9]+)?|^0(?:\.[0-9]+){0,2}\.[0-9]+$|^1(?:\.[0-9]+){0,2}\.[0-9]+$|^127(?:\.[0-9]+){0,2}\.[0-9]+$|^192(?:\.[0-9]+){0,2}\.[0-9]+$|^224(?:\.[0-9]+){0,2}\.[0-9]+$|^255(?:\.[0-9]+){0,2}\.[0-9]+$|^168(?:\.[0-9]+){0,2}\.[0-9]+$|^10(?:\.[0-9]+){0,2}\.[0-9]+$/
