...
const noopString: (a?: any) => '' = (_args?: any) => ''
...
const utilityThemeDefaults: UtilityInterface = {
  ...
  backgroundColor:
    (_color: ColorInterface) => (_backgroundColor: ColorTypes) => ({
      backgroundColor: '',
    }),
  ...
  widthHeight: (_unit: UnitInterface) => (_value: string) => ({
    width: '',
    height: '',
  }),
   ...
   */
  mq:
    (_mediaQuires: MediaQueriesInterface) =>
    (_value: { readonly [key: string]: any }) =>
    (..._args: readonly any[]) =>
      [{}],
